  ...
  return (
    ...
    <div className='max-w-screen-xl m-auto text-center p-4  pt-12 xl:pt-0 md:pt-0 lg:pt-0 sm:pt-12'>
      <div className='relative'>
        ...
        <div className='grid lg:grid-cols-4 md:grid-cols-1 sm:grid-cols-1 mx-10 xl:grid-cols-4 text-center gap-8 mt-12'>
            <div>
                <div className='bg-white border-1 border-[#F9D4D7] p-5 mt-20 hover:bg-[#e42e37] hover:text-[#fff] duration-300 shadow-[9px_12px_22px_0px_#0000001a] hover:scale-110'>
            ...
            <div>
                <div className='bg-white border-1 border-[#F9D4D7] p-5 mt-20 xl:mt-30 md:mt-18 lg:mt-28  hover:bg-[#e42e37] hover:text-[#fff] duration-300 shadow-[9px_12px_22px_0px_#0000001a] hover:scale-110'>
